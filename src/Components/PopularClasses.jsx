...
//           Explore our most popular fitness classes and start your journey today.
//         </p>
//       </div>
...
//               {/* LEVEL BADGE */}
//               <span className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm text-green-600 text-xs font-semibold px-3 py-1.5 rounded-full shadow-sm">
//                 {item.level}
//               </span>
//             </div>
...
//               {/* DESCRIPTION */}
//               <p className="text-gray-600 text-sm sm:text-base leading-6 mb-5 line-clamp-2">
//                 {item.description}
//               </p>
...
//                 className="w-full bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md"
//               >
//                 Learn More
//               </button>
//             </div>
